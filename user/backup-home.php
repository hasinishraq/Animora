...
// Prepare the SQL query to fetch animals for the logged-in user
$stmt = $conn->prepare("SELECT * FROM animals WHERE ownerid = ?");
$stmt->bind_param("i", $ownerId); // Bind the user ID to the query
$stmt->execute();
$result = $stmt->get_result();

// Check if any animals are found
if ($result->num_rows > 0) {
    // Fetch all animals data
...
<body class="text-[color:var(--dark-text)] bg-[color:var(--cream)]">
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="pet-card bg-white rounded-xl p-4">
                        <div class="relative h-40 mb-4 rounded-lg overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1588943211342-0fbd4ef17885?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                                alt="Buddy" class="w-full h-full object-cover">
                            <div class="absolute top-2 right-2">
                                <span class="badge badge-primary">Adoption Active</span>
                            </div>
                        </div>
                        <h3 class="text-xl font-bold mb-1">Buddy</h3>
                        <p class="text-sm text-gray-600 mb-3">Golden Retriever • 3 years old</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                                <span class="badge badge-secondary">Male</span>
                                <span class="badge badge-warning">Dhaka</span>
                            </div>
                            <button class="btn-secondary btn-small">
                    ...
                    <div class="pet-card bg-white rounded-xl p-4">
                        ...
                        <h3 class="text-xl font-bold mb-1">Luna</h3>
                        <p class="text-sm text-gray-600 mb-3">Siamese Cat • 2 years old</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                                <span class="badge badge-secondary">Female</span>
                                <span class="badge badge-warning">Khulna</span>
                            </div>
                            <button class="btn-secondary btn-small">
                                <span class="flex items-center gap-1">
                                    View
                    ...
                    <div class="pet-card bg-white rounded-xl p-4">
                        <div class="relative h-40 mb-4 rounded-lg overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1517849845537-4d2579024541?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                                alt="Hopper" class="w-full h-full object-cover">
                        </div>
                        <h3 class="text-xl font-bold mb-1">Hopper</h3>
                        <p class="text-sm text-gray-600 mb-3">Rabbit • 1 year old</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                                <span class="badge badge-secondary">Male</span>
                                <span class="badge badge-warning">Sylhet</span>
                            </div>
                            <button class="btn-secondary btn-small">
                                <span class="flex items-center gap-1">
                                    View
    ...
    <div class="bg-white rounded-2xl shadow-md p-6 mb-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-[color:var(--mustard)]">Upcoming Appointments</h2>
            <button class="btn-secondary btn-small">
                <span class="flex items-center gap-2">
        ...
        <div class="space-y-4">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($appointment = $result->fetch_assoc()) {
                    ...
                    echo "<div class='appointment-card bg-white rounded-xl p-4'>";
                    echo "<div class='flex flex-col md:flex-row md:items-center justify-between'>";
                    echo "<div class='flex items-start md:items-center mb-4 md:mb-0'>";
                    echo "<div class='mr-4'>";
                    echo "<div class='h-12 w-12 rounded-full bg-[color:var(--mint)] flex items-center justify-center text-[color:var(--mustard)]'>";
                    ...
                    echo "</div>";
                    echo "<div>";
                    echo "<h3 class='font-bold'>$pet_name</h3>";
                    echo "<p class='text-sm text-gray-600'>$reason</p>";
                    echo "</div>";
                    echo "</div>";
                    echo "<div class='text-right'>";
                    echo "<p class='font-bold text-[color:var(--mustard)]'>$slot_date • $start_time - $end_time</p>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                }
                ...
                echo "<p class='text-gray-600'>You have no upcoming appointments.</p>";
            }
            ?>
        </div>
    </div>
