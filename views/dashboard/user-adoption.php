...
<body class="text-[color:var(--dark-text)]">
    ...
    <section
        ...
        <div class="relative z-10 text-center p-6 animate-fade-in-up">
            ...
            <!-- Center Filter Box -->
            <div
                class="relative bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-2xl text-center max-w-xl mx-auto transform transition duration-500 hover:scale-103 border-2 border-[color:var(--mustard)]">
                <h2 class="text-3xl font-bold mb-5 text-[color:var(--mustard)]">What kind of fluff are you searching
                    for?</h2>
                <div class="relative">
                    <select
                        class="w-full px-5 py-3 rounded-xl border-2 border-[color:var(--mint)] text-[color:var(--dark-text)] text-lg focus:outline-none focus:border-[color:var(--mustard)] appearance-none cursor-pointer shadow-sm transition duration-300 bg-white">
                        <option value="" disabled selected>Pick your Pawsome Pal!</option>
                        <option value="dogs">Dogs 🐶</option>
                        <option value="cats">Cats 🐱</option>
                        <option value="rabbits">Rabbits 🐰</option>
                        <option value="birds">Birds 🐦</option>
                        <option value="hamsters">Hamsters 🐹</option>
                        <option value="other">Other Little Creatures 🐾</option>
                    </select>
                    <div
                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-[color:var(--mustard)]">
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row gap-10">
            ...
            <aside
                ...
                <div class="space-y-4">
                    <div>
                        <label for="breed"
                            class="block font-semibold text-lg text-[color:var(--mustard)] mb-1">Breed</label>
                        <input type="text" id="breed" placeholder="e.g. Pug, Siamese"
                    ...
                    <div>
                        <label for="age" class="block font-semibold text-lg text-[color:var(--mustard)] mb-1">Age
                            (Years)</label>
                        <input type="number" id="age" placeholder="e.g. 2" min="0"
                            class="w-full px-4 py-2 border-2 border-[color:var(--mint)] rounded-md focus:outline-none focus:border-[color:var(--mustard)] transition duration-300 shadow-sm text-[color:var(--dark-text)]">
                    </div>

                    <div>
                        <label for="gender"
                            class="block font-semibold text-lg text-[color:var(--mustard)] mb-1">Gender</label>
                        <div class="relative">
                            <select id="gender"
                                class="w-full px-4 py-2 border-2 border-[color:var(--mint)] rounded-md text-[color:var(--dark-text)] text-lg focus:outline-none focus:border-[color:var(--mustard)] appearance-none cursor-pointer shadow-sm transition duration-300 bg-white">
                    ...
                    <div>
                        <label for="color"
                            class="block font-semibold text-lg text-[color:var(--mustard)] mb-1">Color</label>
                        <input type="text" id="color" placeholder="e.g. Calico, Brindle"
                            class="w-full px-4 py-2 border-2 border-[color:var(--mint)] rounded-md focus:outline-none focus:border-[color:var(--mustard)] transition duration-300 shadow-sm text-[color:var(--dark-text)]">
                    </div>

                    <div>
                        <label for="location"
                            class="block font-semibold text-lg text-[color:var(--mustard)] mb-1">Location</label>
                        <input type="text" id="location" placeholder="e.g. Dhaka, Khulna"
                            class="w-full px-4 py-2 border-2 border-[color:var(--mint)] rounded-md focus:outline-none focus:border-[color:var(--mustard)] transition duration-300 shadow-sm text-[color:var(--dark-text)]">
                    </div>

                    <button class="w-full btn-primary mt-5 animate-wiggle-pulse hover:animate-none">
                    ...
                    <button class="w-full btn-secondary mt-3 animate-shake-subtle hover:animate-none">
                        <span class="flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="w-full md:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Pet Card Example (Repeated for demonstration) -->
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--sand)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    ...
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1574144611937-01cd86f87530?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1780&q=80"
                            alt="Adorable Cat Mittens"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Mittens <span
                                class="text-lg">🐱</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Dhaka, Bangladesh • Age: 1.5 years • Female</p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--teal)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    style="animation-delay: 0.2s;">
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1588943211342-0fbd4ef17885?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                            alt="Energetic Dog Buddy"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Buddy <span
                                class="text-lg">🐶</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Chittagong, Bangladesh • Age: 3 years • Male
                        </p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                            <span class="flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--mint)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    style="animation-delay: 0.3s;">
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1517849845537-4d2579024541?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                            alt="Cute Rabbit Hopper"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Hopper <span
                                class="text-lg">🐰</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Sylhet, Bangladesh • Age: 1 year • Female</p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                            <span class="flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--sand)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    ...
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1548681273-0ed850d908ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                            alt="Cute Hamster Nibbles"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Nibbles <span
                                class="text-lg">🐹</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Khulna, Bangladesh • Age: 0.5 years • Male</p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                            <span class="flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--teal)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    ...
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1516035293291-7667232230a1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                            alt="Chirpy Parrot Polly"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Polly <span
                                class="text-lg">🦜</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Dhaka, Bangladesh • Age: 4 years • Female</p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                            <span class="flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xl border-2 border-[color:var(--mint)] transition duration-300 ease-in-out card-pop-shadow flex flex-col items-center text-center animate-fade-in-up"
                    ...
                    <div class="sticker-effect mb-3 w-full">
                        <img src="https://images.unsplash.com/photo-1574144611937-01cd86f87530?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1780&q=80"
                            alt="Sweet Cat Smudge"
                            class="w-full h-56 object-cover rounded-md shadow-sm transform transition duration-500 hover:scale-102">
                    </div>
                    <div class="mt-1 w-full">
                        <h3 class="text-2xl font-bold mb-1 text-[color:var(--mustard)]">Smudge <span
                                class="text-lg">😻</span></h3>
                        <p class="text-[color:var(--teal)] text-sm mb-2">Rangpur, Bangladesh • Age: 0.8 years • Male</p>
                        <button class="btn-primary text-sm px-4 py-2 animate-heartbeat-card-btn hover:animate-none">
                            <span class="flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
