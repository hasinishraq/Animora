...
<body class="bg-bgLight font-poppins text-textPrimary flex min-h-screen relative overflow-hidden">
    ...
    <!-- Sidebar -->
    <aside class="w-64 bg-white shadow-sidebar sticky top-0 h-screen flex flex-col z-30
           hidden md:flex flex-shrink-0">
        <div class="px-6 py-8 flex items-center space-x-3 border-b border-gray-200">
            <div class="text-warmTaupe text-3xl font-semibold animate-pawBounce select-none">🐾</div>
            <h1 class="text-2xl font-semibold font-montserrat tracking-wide text-warmTaupe select-none">Vet Care</h1>
        </div>
        <nav class="flex-1 px-6 py-8 space-y-2 text-sm font-semibold text-textSecondary">
            ...
            <a href="#"
                class="flex items-center gap-3 py-3 px-4 rounded-lg text-warmTaupe bg-warmTaupe/20 transition shadow-inner font-semibold">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
